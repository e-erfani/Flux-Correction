...
SW_d_S_average = double(SW_d_S_average) ;

load SW_N_mean_POP.mat
load latitude_POP.mat 
load longitude_POP.mat
    SW_d_mean_intrp = griddata(lon_msh,lat_msh,SW_d_S_average',longitude,latitude,'natural');
SW_u_S_mean = SW_d_mean_intrp - SW_N_mean ;

temp = SW_u_S_mean(:,25:74) ;
temp(temp < 8) = 9.93 ;
temp(temp > 12) = 9.93 ;
SW_u_S_mean(:,25:74) = temp ;
...
for tt = 1:12
    ...
    tmp2 = griddata(lon_fn_msh,lat_fn_msh,tmp,longitude,latitude,'natural');
    SW_S_u_mo_mean_intrp_POPgrid(:,:,tt) = tmp2' ; 
    tmp = double(SW_S_N_CERES(:,:,tt)') ;
    tmp2 = griddata(lon_fn_msh,lat_fn_msh,tmp,longitude,latitude,'natural');
    SW_S_N_mo_mean_intrp_POPgrid(:,:,tt) = tmp2' ; 
end

%%%%%
cellsize = 0.5; 
SST_T31(:,:,1)  = nanmean(SW_S_u_mo_mean_intrp_POPgrid,3) ;
lat_T31(:,:,1)  = latitude ;
lon_T31(:,:,1)  = longitude ; 
[Z_adjust(:,:,1),refvec_bias(:,:,1)] = geoloc2grid(squeeze(lat_T31(:,:,1)),squeeze(lon_T31(:,:,1)),squeeze(SST_T31(:,:,1)'), cellsize);   
 ...
 lonlim = [1 360]; 
       ...
       fig_name = strcat('SW_u_s_CERES_POPgrid','_annual');
        fig_dum = figure(10);
...
%%%%%
cellsize = 0.5; 
SST_T31(:,:,1)  = double(nanmean(SW_S_N_mo_mean_intrp_POPgrid,3)) ;
lat_T31(:,:,1)  = latitude ;
lon_T31(:,:,1)  = longitude ; 
[Z_adjust(:,:,1),refvec_bias(:,:,1)] = geoloc2grid(squeeze(lat_T31(:,:,1)),squeeze(lon_T31(:,:,1)),squeeze(SST_T31(:,:,1)'), cellsize);   
 latlim = [-75 75];
 lonlim = [1 360]; 
       ...
       fig_name = strcat('SW_N_s_CERES_POPgrid','_annual');
        fig_dum = figure(20);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,12,9]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
...
[Z_adjust(:,:,1),refvec_bias(:,:,1)] = geoloc2grid(squeeze(lat_T31(:,:,1)),squeeze(lon_T31(:,:,1)),squeeze(SST_T31(:,:,1)'), cellsize);   
 ...
 lonlim = [1 360]; 
       ...
       fig_name = strcat('SW_u_s_POPgrid','_annual');
        fig_dum = figure(1);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,12,9]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
...
%%%%%
cellsize = 0.5; 
SST_T31(:,:,1)  = double(SW_u_S_mean' - nanmean(SW_S_u_mo_mean_intrp_POPgrid,3)) ;
lat_T31(:,:,1)  = latitude ;
lon_T31(:,:,1)  = longitude ; 
[Z_adjust(:,:,1),refvec_bias(:,:,1)] = geoloc2grid(squeeze(lat_T31(:,:,1)),squeeze(lon_T31(:,:,1)),squeeze(SST_T31(:,:,1)'), cellsize);   
 latlim = [-75 75];
 lonlim = [1 360]; 
       ...
       fig_name = strcat('Bias_SW_u_s_POPgrid','_annual');
        fig_dum = figure(2);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,12,9]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
...
[Z_adjust(:,:,1),refvec_bias(:,:,1)] = geoloc2grid(squeeze(lat_T31(:,:,1)),squeeze(lon_T31(:,:,1)),squeeze(SST_T31(:,:,1)'), cellsize);   
 ...
 lonlim = [1 360]; 
       ...
       fig_name = strcat('SW_N_s_POP_grid','_annual');
        fig_dum = figure(3);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,12,9]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
...
%%%%%
cellsize = 0.5; 
SST_T31(:,:,1)  = double(SW_N_mean' - nanmean(SW_S_N_mo_mean_intrp_POPgrid,3)) ;
lat_T31(:,:,1)  = latitude ;
lon_T31(:,:,1)  = longitude ;  
[Z_adjust(:,:,1),refvec_bias(:,:,1)] = geoloc2grid(squeeze(lat_T31(:,:,1)),squeeze(lon_T31(:,:,1)),squeeze(SST_T31(:,:,1)'), cellsize);   
 latlim = [-75 75];
 lonlim = [1 360]; 
       ...
       fig_name = strcat('Bias_SW_N_s_POPgrid','_annual');
        fig_dum = figure(4);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,12,9]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
