...
[lon_c_m, lat_c_m] = meshgrid(lon_c, lat_c);
 ...
 SST_mean_interp_c      = griddata(lon_pop,lat_pop,sst_mean,lon_c_m,lat_c_m,'natural');i
...
%%%%%
 cd (address)
      ...
      [C, h] =  m_contourf(lon_HadI, lat_HadI, double(SST_mean_interp_c - SST_Hadley),32);
       set(h,'LineColor','none')
  m_coast('linewidth',1,'color','black');
    Title_1  = 'Control, Low Resolution';
%    Title_1  =strcat('Global Mean=',num2str(var_glb),' ,bias=',num2str(var_bias_glb),' , RMSE=',num2str(var_rmse_glb),' C');
