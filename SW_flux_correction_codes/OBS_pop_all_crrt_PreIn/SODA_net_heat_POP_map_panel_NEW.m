...
%Qnet_average = Qnet_average - 2.70 ;
...
%%%%%
 cd (address)
      fig_name = strcat('net_heat_bias_POP_panel_SODA_NEW');
      fig_dum = figure(1);
...
%%%%%%%%%%%%%%%%
      fig_name = strcat('net_heat_diff_POP_panel_SODA_NEW');
        fig_dum = figure(2);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
...
%%%%%
      fig_name = strcat('ratio_bias_NHF_map_panel_SODA_NEW');
        fig_dum = figure(3);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,13.5,4]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
