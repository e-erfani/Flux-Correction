...
var_mean_obs = var_mean_obs - obs_glb ;
...
%%%%%
 cd (address)
      fig_name = strcat('net_heat_bias_POP_panel_OAFlux_NEW');
      fig_dum = figure(1);
...
%%%%%%%%%%%%%%%%
      fig_name = strcat('net_heat_diff_POP_panel_OAFlux_NEW');
        fig_dum = figure(2);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
...
%%%%%
      fig_name = strcat('ratio_bias_NHF_map_panel_OAFlux_NEW');
        fig_dum = figure(3);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,13.5,4]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
...
%%%%%
 cd (address)
      fig_name = strcat('net_heat_POP_panel');
      fig_dum = figure(10);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,14,8]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
...
axes(ha(1))
    m_proj('miller','long',[0 358],'lat',[-75 75])
    [C, h] =  m_contourf(lon_c_m, lat_c_m, double(var_mean_ctrl_interp_c),50);
    set(h,'LineColor','none')
    m_coast('linewidth',1,'color','black');
    Title_1  = 'ctrl-T31 - obs.';
    title(Title_1,'fontsize',15,'fontweight','bold');
...
axes(ha(2))
    m_proj('miller','long',[0 358],'lat',[-75 75])
    [C, h] =  m_contourf(lon_c_m2, lat_c_m2, double(var_mean_ctrl_interp_c2),50);
    set(h,'LineColor','none')
    m_coast('linewidth',1,'color','black');
    Title_1  = 'ctrl-f19 - obs.';
    title(Title_1,'fontsize',15,'fontweight','bold');
...
axes(ha(3))
    m_proj('miller','long',[0 358],'lat',[-75 75])
    [C, h] =  m_contourf(lon_c_m, lat_c_m, double(var_mean_interp_c),50);
    set(h,'LineColor','none')
    m_coast('linewidth',1,'color','black');
    Title_1  = 'GC-T31 - obs.';
    title(Title_1,'fontsize',15,'fontweight','bold');
...
axes(ha(4))
    m_proj('miller','long',[0 358],'lat',[-75 75])
    [C, h] =  m_contourf(lon_c_m2, lat_c_m2, double(var_mean_interp_c2),50);
    set(h,'LineColor','none')
    m_coast('linewidth',1,'color','black');
    Title_1  = 'GC-f19 - obs.';
    title(Title_1,'fontsize',15,'fontweight','bold');
...
figure()
%plot(lat_zonal2, var_zonal2)
plot(var_zonal2)
hold on
%plot(lat_zonal2, var_zonal_ctrl2)
plot(var_zonal_ctrl2)
print ('-depsc','-tiff','-r600','-painters', 'NHF_test')
